    ...
    export default {
        ...
        methods: {
            ...
            downloadRom: function(id,fileName,status){//下载
                ...
                self.loading = true;
                self.$axios.post('api/strategy/download',params).then(function(res){
                    self.loading = false;
                    if(res.data.ret_code == 0){
            ...
            delRom: function(id,fileName,i){//删除
                ...
                self.$axios.post('/api/script/del',params).then(function(res){
                    ...
                    if(res.data.ret_code == 0){
                        ...
                        self.getScriptList(1, self.page_size);
                    }else{
                        self.$message.error(res.data.extra)
                    }
